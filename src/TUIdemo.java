...
public class TUIdemo extends TApplication {
    ...
    public TUIdemo() throws Exception {
        ...
        Bank.addCustomer("Robert", "Smith");
        Bank.getCustomer(0).addAccount(new SavingsAccount(486.0, 0.08));
        Bank.addCustomer("James", "Hetfield");
        Bank.getCustomer(1).addAccount(new SavingsAccount(7439.0, 0.06));
        //Customer window
        ShowCustomerDetails();
    }
    ...
    protected boolean onMenu(TMenuEvent menu) {
        if (menu.getId() == ABOUT_APP) {
            messageBox("About", "\t\t\t\t\t   Just a simple Jexer demo.\n\nCopyright \u00A9 2023 Immrtldrgn \' Babich").show();
            return true;
        }
